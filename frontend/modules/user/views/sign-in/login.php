...
<div class="site-login mt-5">
    <div class="row justify-content-center">
        <div class="col-sm-4">
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <?php echo Html::a('Forgot your password?', ['sign-in/request-password-reset'], ['class' => ['text-sm']]) ?>
                    </div>

                    <div class="form-group">
                        <?php echo Html::submitButton('Вход', ['class' => 'btn btn-primary btn-lg btn-block', 'name' => 'login-button']) ?>
                    </div>
                    <div class="form-group">
                        <?php if (Yii::$app->getModule('user')->shouldBeActivated) : ?>
                            <?php echo Html::a('Resend my activation email', ['sign-in/resend-email']) ?>
                        <?php endif; ?>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="text-muted text-center"><?php echo 'Войти с помощью'  ?></h4>
