...
<div class="signup mt-5">
    <div class="row justify-content-center">
        <div class="col-sm-4">
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <?php echo Html::submitButton('Sign up', ['class' => 'btn btn-primary btn-lg btn-block', 'name' => 'signup-button']) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="text-muted text-center"><?php echo 'Создать аккаунт с помощью'  ?></h4>
